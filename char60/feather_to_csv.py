...
with open('chars60_Zstd_no_impute.feather', 'rb') as f:
    chars = feather.read_feather(f)
...
# Z standardized
chars_1970s.to_csv('chars60_Zstd_1970s.csv', index=0)
chars_1980s.to_csv('chars60_Zstd_1980s.csv', index=0)
chars_1990s.to_csv('chars60_Zstd_1990s.csv', index=0)
chars_2000s.to_csv('chars60_Zstd_2000s.csv', index=0)
chars_2010s.to_csv('chars60_Zstd_2010s.csv', index=0)
chars_2020s.to_csv('chars60_Zstd_2020s.csv', index=0)